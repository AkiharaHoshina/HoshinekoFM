const zhCT = {
  ...
  'dialog.conflict.operation_save': '儲存',
  'dialog.conflict.title_save': '檔案已存在',
  'dialog.conflict.overwrite': '覆寫（取代現有檔案）',
  ...
  'openrule.title': '開啟方式設定管理',
  'openrule.user_section': '使用者設定',
  'openrule.system_section': '系統設定',
  'openrule.user_empty': '暫時冇使用者設定',
  'openrule.system_empty': '暫時冇系統設定',
  'openrule.user_subtitle': ((exec: string) => `開啟方式：${exec}`),
  'openrule.edit_title': '編輯',
  'openrule.exec_label': '路徑',
  'openrule.clear': '清除設定',
  'openrule.quick_import': '快速匯入',
  'openrule.clear_all': '清除全部使用者設定',
  'openrule.clear_all_confirm': '確定要清除全部使用者設定嗎？所有檔案類型會回歸系統預設開啟方式。',
  'openrule.overridden': '已被使用者設定覆蓋',
  'openrule.copy_unavailable': '無法複製：搵唔到對應嘅應用程式（桌面檔案缺失或冇 Exec 行）',
  'openrule.hint': '系統設定係唯讀，需要將設定複製到使用者設定先可以修改。同一種檔案，會優先使用使用者設定聲明嘅開啟方式。',
  ...
  'settings.search_group_by_dir': '搜尋結果按所在目錄分類',
  ...
  'settings.desktop_entry': '桌面圖示',
  'settings.desktop_entry_desc': '開啟並確定後建立桌面捷徑；關閉並確定後刪除',
  'settings.app_menu_entry': '應用程式選單項目',
  'settings.app_menu_entry_desc': '開啟並確定後建立應用程式選單項目；關閉並確定後刪除',
  'settings.new_tab_path': '新增分頁目錄',
  'settings.new_tab_path_edit': '自訂',
  'settings.open_rule_manager': '開啟方式設定管理',
  'settings.open_rule_manager_desc': '管理各類檔案嘅預設開啟方式（使用者設定優先過系統設定）',
  'settings.open_rule_manager_enter': '進入',
  'newtab.title': '自訂新增分頁目錄',
  'newtab.hint': '支援絕對路徑（例如 /home/user/Downloads）、~/xxx（家目錄下嘅路徑）、app://dashboard（開啟儀表板）同 trash:// 或 trash://資料夾名（開啟垃圾桶或垃圾桶入面嘅目錄）',
  'newtab.invalid': '路徑無效：請輸入以 / 開頭嘅絕對路徑、~/xxx（家目錄）、app://dashboard 或者 trash:// 開頭嘅虛擬路徑',
  ...
  'settings.integration_backend_restart_hint': '舊嘅 portal/FileManager1 常駐程序已清理；本視窗嘅後端已即時更新接管，無需重啟應用',
  ...
  'settings.session_bus_restart_failed': '工作階段匯流排重新啟動失敗',
  'settings.session_bus_restart_confirm_title': '重新啟動工作階段匯流排前確認',
  'settings.session_bus_restart_confirm_message': '重新啟動工作階段匯流排會斷開所有應用的工作階段 D-Bus 連線（其他應用可能短暫異常），用於清除殘留的殭屍佔名。確定繼續嗎？',
  'settings.thumb_cache': '縮圖快取',
  'settings.thumb_cache_info': (n: number, size: string) => `${n} 個檔案 · ${size}`,
  'settings.thumb_cache_empty': '快取為空',
  'settings.clear_thumb_cache': '清除快取',
  'settings.thumb_cache_cleared': (size: string) => `縮圖快取已清除（釋放 ${size}）`,
  'settings.clear_thumb_cache_failed': '清除縮圖快取失敗',
  ...
  'settings.portal_version_mismatch_title': '偵測到 Portal 版本不一致',
  'settings.portal_version_mismatch_message': (installed: string, current: string) => `已安裝嘅 Portal 整合版本係 ${installed}，同而家應用版本 ${current} 不一致。舊版 portal 可能冇辦法正常運作，建議重裝以接管`,
  'settings.portal_version_unknown': '未知',
  'settings.portal_version_restart_hint': '重裝會清理舊版常駐進程，本視窗即時以新版本接管 portal 請求，無需重啟應用',
  'settings.portal_version_reinstall': '一鍵重裝',
  'settings.portal_version_reinstalled': 'Portal 整合已重裝完成',
  'settings.portal_version_reinstalled_hint': '舊版常駐進程已清理，本視窗已即時接管 portal 請求；若仍有舊執行個體回應緊，請重新啟動佢',
