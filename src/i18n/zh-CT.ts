const zhCT = {
  ...
  'newtab.hint': '支援絕對路徑（例如 /home/user/Downloads）、dashboard://（開啟儀表板）同 trash:// 或 trash://資料夾名（開啟垃圾桶或垃圾桶入面嘅目錄）',
  'newtab.invalid': '路徑無效：請輸入以 / 開頭嘅絕對路徑、dashboard:// 或者 trash:// 開頭嘅虛擬路徑',
