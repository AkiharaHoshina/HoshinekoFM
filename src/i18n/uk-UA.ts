...
const ukUA = {
  ...
  'newtab.hint': 'Підтримуються абсолютні шляхи (наприклад, /home/user/Downloads), dashboard:// (відкрити панель) і trash:// або trash://назва_папки (відкрити кошик або каталог у кошику)',
  'newtab.invalid': 'Недійсний шлях: введіть абсолютний шлях (починається з /), dashboard:// або віртуальний шлях trash://',
