...
const ukUA = {
  ...
  'settings.backend_conflict_outdated': (version: string) => `Застарілий бекенд (версія ${version}) досі відповідає на запити portal. Видаліть і перевстановіть системну інтеграцію`,
  'settings.backend_conflict_no_version': 'Застарілий бекенд досі відповідає на запити portal. Видаліть і перевстановіть системну інтеграцію',
  'settings.backend_conflict_unresponsive': 'Служба бекенда не відповідає (можливо, шину займає залишковий процес). Перевстановіть системну інтеграцію або перезапустіть сеансову шину',
