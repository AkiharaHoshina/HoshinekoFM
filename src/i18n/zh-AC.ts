const zhAC = {
  ...
  'context_menu.open_in_terminal': '在默认终端打开',
  ...
  'device.mount_timeout': (device: string) => `挂载 ${device} 逾时，请稍后重试或检查设备`,
  'device.mount_no_device': (device: string) => `${device} 已断连或 USB 位址已变更，请重试`,
