const zhHK = {
  ...
  'newtab.hint': '支援絕對路徑（例如 /home/user/Downloads）、~/xxx（家目錄下嘅路徑）、app://dashboard（開啟儀表板）同 trash:// 或 trash://資料夾名稱（開啟資源回收筒或資源回收筒入面嘅目錄）',
  ...
  'settings.portal_version_mismatch_message': (installed: string, current: string) => `已安裝嘅 Portal 整合版本係 ${installed}，同目前應用版本 ${current} 不一致。舊版 portal 可能冇法正常運作，建議重裝以接管`,
