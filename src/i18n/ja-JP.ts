const jaJP = {
  ...
  'newtab.hint': '絶対パス（例: /home/user/Downloads）、dashboard://（ダッシュボードを開く）、trash:// または trash://フォルダ名（ゴミ箱またはゴミ箱内のディレクトリを開く）に対応',
  'newtab.invalid': '無効なパス：/ で始まる絶対パス、dashboard://、または trash:// で始まる仮想パスを入力してください',
