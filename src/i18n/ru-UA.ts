...
const ruUA = {
  ...
  'settings.backend_conflict_outdated': (version: string) => `Устаревший бэкенд (версия ${version}) всё ещё отвечает на запросы portal. Удалите и переустановите системную интеграцию`,
  'settings.backend_conflict_no_version': 'Устаревший бэкенд всё ещё отвечает на запросы portal. Удалите и переустановите системную интеграцию',
  'settings.backend_conflict_unresponsive': 'Служба бэкенда не отвечает (возможно, шину занимает оставшийся процесс). Переустановите системную интеграцию или перезапустите сеансовую шину',
