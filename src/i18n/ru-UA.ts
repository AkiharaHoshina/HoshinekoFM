...
const ruUA = {
  ...
  'newtab.hint': 'Поддерживаются абсолютные пути (например, /home/user/Downloads), dashboard:// (открыть панель) и trash:// или trash://имя_папки (открыть корзину или каталог в корзине)',
  'newtab.invalid': 'Недопустимый путь: введите абсолютный путь (начинается с /), dashboard:// или виртуальный путь trash://',
