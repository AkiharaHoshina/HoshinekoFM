const zhCN = {
  ...
  'settings.backend_conflict_outdated': (version: string) => `检测到旧版后端（版本 ${version}）仍在应答 portal 请求，请卸载并重装系统集成以接管`,
  'settings.backend_conflict_no_version': '检测到旧版后端仍在应答 portal 请求，请卸载并重装系统集成以接管',
  'settings.backend_conflict_unresponsive': '后端服务无响应（疑似残留进程占用总线名），请重装系统集成或重启会话总线',
