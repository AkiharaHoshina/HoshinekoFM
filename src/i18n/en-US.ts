const enUS = {
  ...
  'settings.backend_conflict_outdated': (version: string) => `An outdated backend (version ${version}) is still answering portal requests. Uninstall and reinstall the system integration to take over`,
  'settings.backend_conflict_no_version': 'An outdated backend is still answering portal requests. Uninstall and reinstall the system integration to take over',
  'settings.backend_conflict_unresponsive': 'The backend service is not responding (a leftover process may hold the bus name). Reinstall the system integration or restart the session bus',
