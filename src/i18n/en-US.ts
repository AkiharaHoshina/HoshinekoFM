const enUS = {
  ...
  'newtab.hint': 'Accepts an absolute path (e.g. /home/user/Downloads), dashboard:// (open the dashboard), or trash:// / trash://folder (open the trash or a directory inside it)',
  'newtab.invalid': 'Invalid path: enter an absolute path (starting with /), dashboard://, or a virtual path starting with trash://',
