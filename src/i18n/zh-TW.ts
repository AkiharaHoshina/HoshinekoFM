const zhTW = {
  ...
  'newtab.hint': '支援絕對路徑（例如 /home/user/Downloads）、dashboard://（開啟儀表板）與 trash:// 或 trash://資料夾名稱（開啟資源回收筒或資源回收筒中的目錄）',
  'newtab.invalid': '無效路徑：請輸入絕對路徑（以 / 開頭）、dashboard:// 或 trash:// 開頭的虛擬路徑',
