const zhTW = {
  ...
  'settings.integration_backend_restart_hint': '舊的 portal/FileManager1 常駐程序已清理；本視窗的後端在應用重啟後更新',
  ...
  'settings.portal_version_restart_hint': '重裝完成後需重啟應用，本視窗的後端才會以新版本回應 portal 請求',
